...
public class TestSVG {
    ...
    public void testGenerateSvg() throws Exception {
        ...
        List<AbstractShape> shapeFor = mapper.getShapeFor(JavaParser.parse(new File("C:\\Users\\mbelmokhtar\\Desktop\\Nouveau dossier\\svg4j\\src\\test\\java\\Example.java")));
        SVGPlan plan = new SVGPlan(10240, 7680);
        plan.addAll(shapeFor);
        System.out.println(shapeFor);
